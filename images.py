...
# Define the frame rate (fps) for speed calculation
fps = 200  # Adjust based on the actual time between frames

# Define the scaling factor from pixels to meters
...
prev = cv2.imread(os.path.join(image_folder, image_files[0]))
prevgray = cv2.cvtColor(prev, cv2.COLOR_BGR2GRAY)

# Process each consecutive pair of images (frames)
